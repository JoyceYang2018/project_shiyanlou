...
class Frame(wx.Frame):
    ...
    def initGame(self):
        ...
        count=0
        while count<2:
            #对4x4期盼进行初始化，最开始在棋盘上随机产生2个2或4数字
    ...
    def initBuffer(self):
        ...
        #定义一块buffer用来使用BufferedDC画图

    def onSize(self,event):
        #窗口改变时重新initBuffer，drawAll来画界面
        self.initBuffer()
        self.drawAll()
    ...
    def isGameOver(self):
        ...
        self.slideLeftRight(False)[0]:
            flag = True
        if not not flag:self.data = copyData
        return flag
